...
str = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT \<CENTER><IMG src="bodyguard.jpg"><BR><FONT color=#ffd000>One small letter, surrounded by <B>EXACTLY</B> three big bodyguards on each of its sides. </CENTER><BR><BR>To see the solutions to the previous level, replace pc with pcc, i.e. go to: http://www.pythonchallenge.com/pcc/def/equality.html <BR><BR>Join us on IRC: irc.freenode.net #pythonchallenge <!--
